...
def green_mountain():
    ...
    for i in range(0, 40):
        for j in range(0, 40):
            ...
            vertex(5*i-100, 5*j-100, 0, 0.025*i, 0.025*j)
            vertex(5*(i+1)-100, 5*j-100, 0, 0.025*(i+1), 0.025*j)
            vertex(5*(i+1)-100, 5*(j+1)-100, 0, 0.025*(i+1), 0.025*(j+1))
            vertex(5*i-100, 5*(j+1)-100, 0, 0.025*i, 0.025*(j+1))
            endShape()
